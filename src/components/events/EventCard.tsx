  ...
  return (
    <div className={`relative ${event.condamnation_judiciaire && 'mt-6'}`}>
      ...
      <div className="flex items-center justify-between mb-2">
        {/* Nom de la marque */}
        <h3 className="heading-sub font-bold text-primary">
          {event.marque?.nom && (() => {
        ...
        <span className="body-small sm:body-base text-secondary font-medium shrink-0">
      ...
      {event.source_url && (
        <div className="pt-4 border-t border-neutral">
          <a
            ...
            className="inline-flex items-center body-base font-medium text-violet-magenta-600 hover:text-violet-magenta-700 transition-colors duration-200"
          >
