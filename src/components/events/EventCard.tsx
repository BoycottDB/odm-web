...
export function EventCard({ event }: EventCardProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10 bg-white rounded-3xl p-8 shadow-lg border border-berry-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
