...
export function MarquesBadges({ 
  ...
  const badgeStyles = variant === 'admin' 
    ? "inline-flex items-center px-2.5 py-0.5 rounded-full body-xs font-medium bg-primary-light text-primary cursor-pointer hover:bg-primary hover:text-white transition-colors"
    : "inline-flex items-center px-3 py-1 rounded-full body-small font-medium bg-white text-primary border border-primary cursor-pointer hover:bg-primary hover:text-white transition-colors";
