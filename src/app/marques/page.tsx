            ...
            <>              
              ...
              {marques.map((marque) => (
                <div
                  ...
                  className="bg-white border border-primary-medium rounded-3xl p-4 md:p-6 cursor-pointer transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1 md:relative"
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {(marque.nbControverses > 0 || marque.nbCondamnations > 0) && (
