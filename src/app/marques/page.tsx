...
export default function MarquesPage() {
  ...
  const handleMarqueClick = (nom: string) => {
        ...
        <section className="section-padding">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center">
              ...
              <p className="body-base text-neutral-600 mt-4">Chargement des marques...</p>
            </div>
          </div>
        </section>
      </div>
            ...
            <>              
              ...
              {marques.map((marque) => (
                <div
                  ...
                  className="bg-white border-2 border-primary-100 rounded-2xl p-6 cursor-pointer transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1"
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="heading-main font-semibold text-primary md:min-w-100">
                          {(() => {
