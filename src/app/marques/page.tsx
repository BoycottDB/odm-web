            ...
            <>              
              ...
              {marques.map((marque) => (
                <div
                  ...
                  className="bg-white border border-primary-medium rounded-3xl p-6 cursor-pointer transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1"
                >
