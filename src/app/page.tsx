    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-orange-50">
      ...
      <section className="relative bg-gradient-to-r from-orange-50 via-amber-50 to-yellow-50 py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          {/* Encadré informatif */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-8 max-w-3xl mx-auto border border-orange-100 shadow-lg">
            ...
            <div className="text-center">
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-medium rounded-full hover:from-orange-600 hover:to-amber-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
