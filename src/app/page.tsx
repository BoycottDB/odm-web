...
export default function Home() {
  ...
  // Sections avec composants réutilisables
      ...
      <div className="order-1 lg:order-2 text-left">
        ...
        <div className="flex justify-start md:justify-start">
          <Link 
            ...
            className={`inline-flex items-center px-4 py-2 md:px-6 md:py-3 font-semibold rounded-lg transition-colors text-sm md:text-base ${
              isMobile 
      ...
      <section className="relative bg-gradient-to-r from-primary-light via-purple-50 to-indigo-50 section-padding">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="space-y-8 md:space-y-16">
            {isMobile ? (
              <>
                {/* Mobile : Recherche d'abord */}
                <SearchSection />
                {/* Mobile : Signalement en second */}
                <SignalementSection />
                {/* Mobile : Extension en dernier */}
                <ExtensionSection />
              </>
            ) : (
              <>
                {/* Desktop : Extension d'abord */}
                <ExtensionSection />
                {/* Desktop : Recherche en second */}
                <SearchSection />
                {/* Desktop : Signalement en dernier */}
                <SignalementSection />
              </>
            )}
          </div>
