        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-4">Principe de modération</h2>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-6">Critères de validation</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="border-l-4 border-green-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">✅ Accepté si :</h3>
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">❌ Refusé si :</h3>
                    <ul className="text-gray-700 space-y-2">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-6">Historique des décisions</h2>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 body-small">
                ...
                <div className="space-y-4">
                  <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center">
                        <span className="bg-red-100 text-red-800 body-xs font-medium px-2.5 py-0.5 rounded-full mr-3">&quot;REFUSÉ&quot;</span>
                        <span className="font-semibold text-gray-900">&quot;Controverse Nike - Conditions de travail&quot;</span>
                      </div>
                      <span className="body-small text-gray-500">30 juillet 2025</span>
                    </div>
                  ...
                  <div className="border border-green-200 rounded-lg p-4 bg-green-50">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center">
                        <span className="bg-green-100 text-green-800 body-xs font-medium px-2.5 py-0.5 rounded-full mr-3">&quot;VALIDÉ&quot;</span>
                        <span className="font-semibold text-gray-900">&quot;Controverse Nestlé - Gestion de l&apos;eau&quot;</span>
                      </div>
                      <span className="body-small text-gray-500">29 juillet 2025</span>
                    </div>
                    <p className="text-gray-700 mb-2">
                  ...
                  <div className="border border-blue-200 rounded-lg p-4 bg-blue-50">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center">
                        <span className="bg-blue-100 text-blue-800 body-xs font-medium px-2.5 py-0.5 rounded-full mr-3">&quot;MODIFIÉ&quot;</span>
                        <span className="font-semibold text-gray-900">&quot;Controverse Amazon - Évasion fiscale&quot;</span>
                      </div>
                      <span className="body-small text-gray-500">28 juillet 2025</span>
                    </div>
                    <p className="text-gray-700 mb-2">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-4">Comment signaler</h2>
