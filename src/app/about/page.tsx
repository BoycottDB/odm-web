...
export default function About() {
  return (
    <div className="w-full">
      {/* Section Hero */}
      <section className="bg-gradient-to-r from-primary-50 via-violet-magenta-50 to-lavande-50 py-16 px-4">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mt-8 max-w-3xl mx-auto border border-primary shadow-lg">
          ...
          <div className="text-center">
            <a
              ...
              className="body-small inline-flex items-center px-6 py-3 bg-gradient-odm text-white font-medium rounded-full hover:from-primary-hover hover:to-primary-hover transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
