...
export default function About() {
  return (
    <div className="w-full">
      {/* Section Hero */}
      <section className="bg-gradient-to-br from-berry-50 via-purple-50 to-indigo-50 py-16 px-4">
        ...
        {/* Encadré informatif */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mt-8 max-w-3xl mx-auto border border-berry-100 shadow-lg">
          <p className="body-base font-light text-gray-700 mb-4 text-center">
          ...
          <div className="text-center">
            <a
              ...
              className="body-small inline-flex items-center px-6 py-3 bg-gradient-to-r from-berry-500 to-berry-500 text-white font-medium rounded-full hover:from-berry-600 hover:to-berry-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-4">Notre mission</h2>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-6">Nos valeurs fondamentales</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">Transparence totale</h3>
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">Collaboration communautaire</h3>
                  ...
                  <div className="border-l-4 border-berry-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">Neutralité et responsabilité</h3>
                  ...
                  <div className="border-l-4 border-berry-500 pl-4">
                    <h3 className="font-semibold body-large text-gray-900 mb-2">Non lucratif</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
            <div className="flex items-start mb-6">
              ...
              <div className="flex-1">
                <h2 className="heading-main font-bold text-gray-900 mb-4">Comment ça fonctionne</h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-blue-500 text-white rounded-full w-8 h-6 flex items-center justify-center body-small font-bold mr-4 mt-1">1</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="bg-blue-500 text-white rounded-full w-8 h-6 flex items-center justify-center body-small font-bold mr-4 mt-1">2</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="bg-blue-500 text-white rounded-full w-8 h-6 flex items-center justify-center body-small font-bold mr-4 mt-1">3</div>
                    <div>
