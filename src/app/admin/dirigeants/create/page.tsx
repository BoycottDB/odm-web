    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Nouveau dirigeant controversé</h1>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Sélection de la marque</h2>
