    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="heading-hero font-bold text-gray-900">Nouveau dirigeant controversé</h1>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
          <h2 className="body-large font-semibold text-gray-900 mb-4">Sélection de la marque</h2>
          ...
          {availableMarques.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">Toutes les marques ont déjà un dirigeant controversé associé.</p>
              <button
