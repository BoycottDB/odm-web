...
function MobileNav() {
  ...
  return (
    <>
      <button
        className="md:hidden flex items-center justify-center w-10 h-10 rounded-full border border-primary bg-white shadow hover:bg-primary-50 transition-all focus:outline-none focus:ring-2 focus:ring-primary relative z-50"
      ...
      {open && (
        ...
        >
          ...
          <nav className="flex flex-col gap-4 p-4 bg-white border-b border-primary-200 rounded-b-2xl" role="navigation" aria-label="Navigation mobile">
...
export default function RootLayout({
  ...
  const getDesktopLinkClass = (href: string) => {
    const isActive = pathname === href;
    return `body-base font-medium px-3 py-2 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-accent ${isActive
        ? 'text-accent bg-accent-light'
        : 'text-[#3d2a30] hover:text-accent hover:bg-secondary-light'
      }`;
  };
  return (
    <html lang="fr">
            ...
            <div className="border-t border-secondary pt-8">
              ...
              <div className="text-center mt-4">
                <a
                  ...
                  className="body-small inline-flex items-center px-6 py-3 bg-gradient-to-r bg-black hover:bg-gradient-odm text-white font-medium rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
